...
class CustomTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      focusNode: focusNode,
      style: TextStyle(fontSize: fontSize ?? 12 * sp, fontFamily: 'DMSans', fontWeight: fontWeight, height: height, color: textColor),
      ...
      decoration: InputDecoration(
        contentPadding: contentPadding ?? EdgeInsets.symmetric(vertical: 10 * sp, horizontal: 10 * sp),
        isDense: true,
        ...
        enabledBorder: enabledBorder ?? border ?? OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius ?? 10), borderSide: borderSide ?? BorderSide(color: Colors.grey)),
        focusedBorder: focusedBorder ?? border ?? OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius ?? 10), borderSide: borderSide ?? BorderSide(color: ThemeColor.mainColor)),
        hintText: label,
